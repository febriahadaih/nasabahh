...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Motor List</h2>
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('motor/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
		...
		<th>Action</th>
			...
			<td><?php echo $motor->merek ?></td>
			<td><?php echo $motor->created_at ?></td>
			<td><?php echo $motor->created_by ?></td>
			<td><?php echo $motor->updated_at ?></td>
			<td><?php echo $motor->updated_by ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('motor/read/'.$motor->nopol),'Read'); 
				echo ' | '; 
				echo anchor(site_url('motor/update/'.$motor->nopol),'Update'); 
				echo ' | '; 
				echo anchor(site_url('motor/delete/'.$motor->nopol),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
